...
namespace API
{
    ...
    struct Action
    {
        ...
        void Move(const sc2::Unit* unit_, const sc2::Point2D& point_);
        void Move(const sc2::Units& units_, const sc2::Point2D& point_);
        void Cast(const sc2::Unit& assignee_, sc2::ABILITY_ID ability_);
        void Cast(const sc2::Unit& assignee_, sc2::ABILITY_ID ability_, const sc2::Unit& target_, bool queued = false);
    ...
    struct Debug
    {
        ...
        void DrawText(float value_, const sc2::Point3D& point_, const sc2::Color& color_ = sc2::Colors::White) const;
        void DrawText(const std::string& message_, const sc2::Point3D& pos_) const;
        void DrawSphere(const sc2::Point3D& center_, float radius_, const sc2::Color& color_ = sc2::Colors::White) const;
        void DrawTile(const sc2::Point3D& point_, const sc2::Color& color_) const;
        void DrawBox(const sc2::Point3D& min_, const sc2::Point3D& max_, const sc2::Color& color_ = sc2::Colors::White) const;
        void DrawLine(const sc2::Point3D& start_, const sc2::Point3D& end_, const sc2::Color& color_ = sc2::Colors::White) const;
        void EndGame() const;
    ...
    struct Observer
    {
        ...
        Units GetUnits(sc2::Unit::Alliance alliance_ = sc2::Unit::Alliance::Self) const;
        Units GetUnits(const sc2::Filter& filter_, sc2::Unit::Alliance alliance_ = sc2::Unit::Alliance::Self) const;
