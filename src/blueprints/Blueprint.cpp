...
std::shared_ptr<Blueprint> Blueprint::Plot(sc2::ABILITY_ID ability_)
{
    switch (ability_)
    {
        ...
        {
            return std::make_shared<HighTechUnit>(sc2::UNIT_TYPEID::TERRAN_STARPORT, sc2::UNIT_TYPEID::TERRAN_STARPORTTECHLAB);
        }
        ...
        {
            return std::make_shared<HighTechUnit>(sc2::UNIT_TYPEID::TERRAN_FACTORY, sc2::UNIT_TYPEID::TERRAN_FACTORYTECHLAB);
        }
        ...
        {
            return std::make_shared<HighTechUnit>(sc2::UNIT_TYPEID::TERRAN_BARRACKS, sc2::UNIT_TYPEID::TERRAN_BARRACKSTECHLAB);
        }
